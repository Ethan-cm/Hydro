...
#define can_send(dev, msg, timeout, callback_isr, callback_arg) ({ 	int retval; 	sys_port_trace_syscall_enter(K_SYSCALL_CAN_SEND, can_send, dev, msg, timeout, callback_isr, callback_arg); 	retval = can_send(dev, msg, timeout, callback_isr, callback_arg); 	sys_port_trace_syscall_exit(K_SYSCALL_CAN_SEND, can_send, dev, msg, timeout, callback_isr, callback_arg, retval); 	retval; })
#endif
#endif
